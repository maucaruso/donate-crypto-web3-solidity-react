            ...
            <>
              ...
              <div className="row flex-lg-row-reverse align-items-center g-5">
                ...
                <div className="col-5 mb-5" style={{ height: 480, scrollbars: true }}>
                  ...
                  {
                    campaign.videoUrl
                      ? <p>Assista ao vídeo a seguir para saber os detalhes da nossa campanha.</p>
                      : <></>
                  }
                  
                  <p className="mb-3 fst-italic mt-5">
                    E aí, o que achou do projeto? Já foi arrecadado {campaign.balance / 10 ** 18} BNB nesta campanha. Quanto você deseja doar (em BNB)?
                  </p>
                  
                  <div className="mb-3">
                    <div className="input-group">
                      <input type="number" name="donation" id="donation" className="form-control" onChange={onChangeValue} value={donation} />
